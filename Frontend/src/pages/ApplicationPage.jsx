  ...
  const apps = [
    {
      ...
      disabled: (isWhitelisted && !isAdmin)
    },
    {
      id: 'pd',
             ...
             <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                {app.locked ? (
                  ...
                  <AnimatedButton onClick={app.action} className={`w-full sm:w-auto ${app.id === 'whitelist' && isWhitelisted && !isAdmin ? 'bg-green-600' : 'bg-cyan-600'}`} disabled={app.disabled}>
                    {app.btnText}
                  </AnimatedButton>
                )}
              </div>
