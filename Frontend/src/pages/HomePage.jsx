        ...
        <div className="animate-fade-in w-full">
            ...
            <div className="relative h-screen flex flex-col items-center justify-center overflow-hidden -mt-16">
                ...
                <div className="relative z-20 text-center px-4 sm:px-6 w-full max-w-5xl mx-auto flex flex-col items-center">
                    <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-white tracking-tighter mb-4 md:mb-6 drop-shadow-2xl text-center leading-tight">
                        <div className="block">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-500">LS</span>REBORN
                        </div>
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 font-light tracking-wide mb-6 md:mb-10 max-w-2xl mx-auto px-2">
                        Redefining the standard of <span className="text-cyan-400 font-medium">Roleplay</span>. Your story in LSReborn begins here.
                    </p>
                        ...
                        <div className="h-full bg-gray-900/40 backdrop-blur-md border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col justify-between relative overflow-hidden group hover:border-cyan-500/20 transition-all duration-500">
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-2">
                                    <span className="text-gray-400 text-xs md:text-sm font-medium tracking-wider uppercase">LSReborn Status</span>
                    ...
                    <div className="md:col-span-8">
                        <div className="h-full flex flex-col justify-center space-y-6 p-2 md:p-4">
                            ...
                            <p className="text-gray-400 text-base md:text-lg leading-relaxed">
                                We aren't just another server; we are a community-driven project aimed at providing the most immersive storytelling environment possible in LSReborn.
