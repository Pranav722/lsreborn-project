...
const AuditLogs = ({ user }) => {
    ...
    const [logs, setLogs] = useState([
        { id: 1, timestamp: new Date().toISOString(), user: 'admin', action: 'Approved application for Jax Teller.' },
        { id: 2, timestamp: new Date(Date.now() - 3600000).toISOString(), user: 'mod', action: 'Rejected application for Isabella Rossi.' },
    ]);
        ...
        <div className="animate-fade-in">
            ...
            <div className="relative mb-6">
                <input 
                    ...
                    className="w-full bg-gray-900/70 border border-cyan-500/30 rounded-lg px-4 py-3 pl-12 text-white focus:ring-2 focus:ring-cyan-400 focus:outline-none" 
                />
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-cyan-500/20">
                                    <th className="p-4 text-cyan-300">Timestamp</th>
                                    <th className="p-4 text-cyan-300">User</th>
